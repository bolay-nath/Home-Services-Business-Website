      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="text-center mb-24">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-gray-900 via-gray-800 to-black bg-clip-text text-transparent mb-6">
            Professional Painting & Home Services
          </h2>
                ...
                {section.services.map((service, idx) => (
                  ...
                  >
                    ...
                    <div className="h-52 lg:h-60 w-full overflow-hidden">
                      <Image
                        src={service.image}
                        alt={`${service.title} painting service in Dubai`}
                        width={500}
                        height={350}
        ...
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-lg mx-auto">
            Contact us today for villa, apartment, and commercial painting
            services with free consultation.
          </p>
